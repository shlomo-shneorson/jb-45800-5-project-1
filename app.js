...
function updateExpense(date) {
  ...
  expenses[currentExpense] = {
    ...
    discrioptionOfExpense: document.getElementById("discrioptionOfExpense")
      .value,
...
function filterExpense(event) {
  ...
  let userMaxHight = document.getElementById("hightFilter").value;

  if (userMaxHight == "") {
    userMaxHight = Infinity;
  } else {
    userMaxHight = +userMaxHight;
  }
